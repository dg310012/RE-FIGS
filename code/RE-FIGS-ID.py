...
if len(good_target) < 2:
    print("The program has ended ahead of schedule, the number of good target is "+"%d" %
          len(good_target)+", less than 2! Please choose another parameter.")
    sys.exit()
if len(good_target) < 500:
    print("Not a warning, the number of good target is "+"%d" %
